...
const incentivizedPools = [
  {
    ...
    rewards_token: 'DOUGH',
    weeklyRewards: formatFiat(80000, ',', '.', ''),
    apy: 1.8,
    toStakeSymbol: 'BPT',
  ...
  },
  {
    ...
    platform: '🥧 PieDAO',
    rewards_token: 'DOUGH',
    weeklyRewards: formatFiat(30000, ',', '.', ''),
    apy: 1.8,
    toStakeSymbol: 'BCP',
  ...
  },
  {
    ...
    addressUniPoll: '0xFcBB61bcd4909bf4AF708F15AAaa905E0978cAfc',
    aprEnabled: true,
    deprecated: false,
    description: 'WEEKLY REWARDS (Escrowed)',
    platform: '⚖️ Balancer',
  ...
  },
  {
    ...
    addressUniPoll: '0xb8E59ce1359d80E4834228eDd6a3F560e7534438',
    aprEnabled: true,
    deprecated: false,
    description: 'WEEKLY REWARDS (Escrowed)',
    platform: '⚖️ Balancer',
  ...
  },
  {
    ...
    toStakeDesc: 'Balancer: DEFI+S/ETH 70/30',
    platform: '⚖️ Balancer',
    description: 'End 12/05/20, 7pm UTC',
    weeklyRewards: 0,
    apy: 1.8,
    allowance: 0,
    allowanceKey: '',
