...
class Experipie {
  ...
  async fetchLentAssets() {
    let balancesOnSelectedProtocols = await this.defiSdk.getProtocolBalances(this.address, [
      'Aave',
      'Compound',
      'C.R.E.A.M.',
    ]);
        ...
        protocolBalances.balances.forEach((balance) => {
          ...
          this.map[balance.base.metadata.token.toLowerCase()] = {
            ...
            balance: {
              ...
              label: getNormalizedNumber(
                balance.base.amount.toString(),
