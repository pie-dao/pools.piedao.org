...
<div class="videocontainer">
  ...
  <div class="content flex flex-col spl px-4">
    <div
      class="text-24px font-bold text-lg md:leading-8 text-center mb-4"
      data-aos="fade-up"
      data-aos-delay="100"
    >
    ...
    <div
      ...
      data-aos-delay="200"
    >
      Contribute and be rewarded<br />for building a better organizazion and products.
    </div>
    <button
      class="items-center stakinggradient shake text-black text-left mt-20 md:mt-4 hover:opacity-80"
      onclick="location.href='https://app.1inch.io/#/1/swap/ETH/DOUGH';"
      data-aos="fade-up"
      data-aos-delay="250"
    >
