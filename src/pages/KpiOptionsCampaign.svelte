...
<div class="md:hidden flex flex-row w-70pc ml-15pc">
  ...
  <div class="text-center w-50px">
    <div class="w-50px bg-lightgrey rounded-circle h-full p-0 m-0 relative">
      ...
      >
        <span
          class="font-bold w-50px m-25pc text-left items-left h-100pc mb-50px rotate180"
          style="writing-mode: vertical-lr; text-orientation: sideways-left;"
          >{formatFiat(totalStakedDough, ',', '.', '')} DOUGH</span
        >
      </div>
    </div>
  </div>
      ...
      <div class="w-full h-100px p-0 m-0 relative">
        <div class="z-40 flex items-center absolute w-100pc h-100px top-8pc">
          <div class="flex flex-col items-center absolute ml-41pc text-center">
            {#if totalStakedDough >= 7000000}
              <img src={images.one_m_prize_text_bg} alt="" width="80px" />
              <div class="w-1px h-30px dashed mb-22px" />
            {:else}
              <img src={images.one_m_prize_text} alt="" width="80px" />
              <div class="w-1px h-30px dashed mt-10px" />
            {/if}
          </div>
          <div class="flex flex-col items-center absolute ml-61pc text-center">
            {#if totalStakedDough >= 10000000}
              <img src={images.two_m_prize_text_bg} alt="" width="80px" />
              <div class="w-1px h-30px dashed mb-20px" />
            {:else}
              <img class="pb-4px" src={images.two_m_prize_text} alt="" width="80px" />
              <div class="w-1px h-30px dashed mt-15px" />
            {/if}
          </div>
      ...
      <div class="w-full h-90px p-0 m-0 relative">
        <div class="z-40 flex items-center absolute w-100pc h-90px text-center leading-5 mt-3">
          <div class="w-80px flex flex-col items-center absolute ml-41pc">
            <div class="w-1px h-30px dashed" />
            <span class="mt-2">7M DOUGH<br />Staked</span>
          </div>
          <div class="w-80px flex flex-col items-center absolute ml-61pc">
            <div class="w-1px h-30px dashed" />
            <span class="mt-2">10M DOUGH<br />Staked</span>
          </div>
          <div class="w-80px flex flex-col items-center absolute ml-90pc">
            <div class="w-1px h-30px dashed" />
            <span class="mt-2">15M DOUGH<br />Staked</span>
          </div>
        </div>
      </div>
    </div>
...
<div class="flex flex-col items-center text-center mt-6 md:mt-10 mx-8">
  <div class="flex flex-col items-center w-full max-w-1100px pb-12 px-0 md:px-10">
    ...
    <div class="w-full font-thin text-l text-center mt-20px">
      <p>
        Everyone that has staked Dough during October 2021 is eligible! If you did check your
        address
        <u
          ><a
            href="https://bafybeifonjk7bchsdlljsbf4gywpcyuyn4634fddu2iccd6uzfyxmmkow4.ipfs.infura-ipfs.io/"
            >here</a
          ></u
        >
        <br />
      ...
      >
        <div class="flex flex-col w-full md:w-1/3 justify-center m-2">
          <div class="flex flex-row w-full text-center items-center">
            <img
              ...
              src="https://github.com/pie-dao/brand/blob/master/misc/1.svg?raw=true"
              alt=""
              data-aos="fade-up"
              data-aos-delay="50"
            />
        ...
        <div class="flex flex-col w-full md:w-1/3 justify-center m-2">
          <div class="flex flex-row w-full text-center items-center">
            <img
              class="w-full max-h-80px"
              src="https://github.com/pie-dao/brand/blob/master/misc/2.svg?raw=true"
              alt=""
              data-aos="fade-up"
              data-aos-delay="50"
            />
        ...
        <div class="flex flex-col w-full md:w-1/3 justify-center m-2">
          <div class="flex flex-row w-full text-center items-center">
            <img
              class="w-90pc md:w-full max-h-80px"
              src="https://github.com/pie-dao/brand/blob/master/misc/3.svg?raw=true"
              alt=""
              data-aos="fade-up"
              data-aos-delay="50"
            />
