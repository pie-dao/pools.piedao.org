...
<div class="flex flex-col items-center text-center mt-4 md:mt-10 mx-8">
  <div class="flex flex-wrap justify-around w-full max-w-1100px pb-12 px-10">
    ...
    <div class="font-thin text-l md:text-lg text-center mt-20px">
...
<div class="content flex flex-col w-100pc justify-between spl lg:flex-row-reverse">
  <div class="flex w-full flex-col mt-0 md:mt-10 p-4 lg:w-3/7">
      <img class="w-100pc h-auto md:w-100pc h-auto" src={images.discuss} alt="Discuss" data-aos="fade-up" data-aos-delay="0" />
    </div>
  <div class="flex w-full lg:w-4/7 flex-col lg:pr-4">
    <div class="text-xl leading-10 mb-4" data-aos="fade-up" data-aos-delay="50"></div>
    <div class="font-thin text-l mb-20px lg:mb-50px" data-aos="fade-up" data-aos-delay="100">
...
<div class="content flex flex-col w-100pc justify-between spl lg:flex-row">
  <div class="flex w-full flex-col mt-4 md:mt-10 p-4 lg:w-3/7">
      <img class="w-100pc h-auto md:w-100pc h-auto" src={images.earntogether} alt="Discuss" data-aos="fade-up" data-aos-delay="0" />
    </div>
  <div class="flex w-full lg:w-4/7 flex-col lg:pr-4">
    <div class="text-xl leading-10 mb-4" data-aos="fade-up" data-aos-delay="50">
...
<div class="content flex flex-col w-100pc justify-between spl lg:flex-row-reverse">
  <div class="flex w-full flex-col mt-4 md:mt-10 p-4 lg:w-3/7">
      <img class="w-100pc h-auto md:w-100pc h-auto" src={images.metavote} alt="Discuss" data-aos="fade-up" data-aos-delay="0"/>
    </div>
  <div class="flex w-full lg:w-4/7 flex-col lg:pr-4">
      <div class="text-xl leading-10 mb-4" data-aos="fade-up" data-aos-delay="50">
  ...
  <section class="pt-12 pb-6 px-4 text-center">
    <div class="w-full max-w-2xl mx-auto">
      <h2 class="text-xl mt-6 mb-3 leading-tight font-heading" data-aos="fade-up" data-aos-delay="0">Got more questions?</h2>
    </div>
  </section>
  
  
  <div class="w-100pc px-2 md:px-8" data-aos="fade-up" data-aos-delay="100">
  <AccordionGroup>
  ...
  <button on:click={() => addToken()} class="add-dough-metamask mt-4" data-aos="fade-up" data-aos-delay="50">
    Add to MetaMask 🦊
  </button>
</div>
