...
<div class="content flex flex-col w-100pc justify-between spl lg:flex-row">
  ...
  <div class="flex w-full lg:w-4/7 flex-col lg:pr-4">
    ...
    <div class="font-thin text-l mb-20px lg:mb-50px">
      ...
      <a class="font-bold mt-4 md:mt-4" target="_blank" href={`https://medium.com/piedao/dough-farming-season-7329ea5e84dd`}>Learn about DOUGH token economics</a><br/>
      </div>
    </div>
</div>
...
<div class="content flex flex-col w-100pc justify-between spl lg:flex-row-reverse">
  ...
  <Accordion class="flex flex-col">
    <button class="accordionbutton flex flex-col" slot="header" let:toggle on:click={toggle}>Is DOUGH a security?</button>
    <div class="accordioncontent">
      something    
    </div>
  </Accordion>
