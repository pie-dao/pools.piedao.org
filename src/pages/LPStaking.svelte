...
<div class="cardbordergradient">
<ModalBig title="DOUGH / ETH" backgroundColor="#ffffff" bind:this="{modalinfo}">


  <a class="flex mt-4 w-100pc rounded-xl bg-white p-4 pointer" href="xx">
  ...
  <span slot="content" class="p-12 font-thin">


    <span class="flex mt-4 w-100pc rounded-xl bg-white p-4">
      <div class="mr-4 flex items-center">
        <img
          class="z-10"
          width="60px"
      ...
      <span class="mt-1 mb-2">
        <div class="w-100pc flex flex-col cardbordergradient">
          ...
          >
            ...
            <a class="flex mt-4 w-100pc rounded-xl bg-white p-4 pointer" on:click={() => {
              modalinfo.open()
            }}>
              <div class="mr-4 flex items-center">
                <img
