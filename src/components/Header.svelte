    ...
    <div use:clickOutside on:click_outside={closeDropdown2}>
      ...
      {#if dropdownOpen2}
        <div class="z-50 origin-top-right absolute right-0 mt-1 thinborder w-56 drowpdown-shadow roundedl">
          <div class="bg-white roundedl" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            <div class="py-1 roundedl">
              <a href="#/new_staking" on:click={toggleDropdow2} class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" role="menuitem">📢 Governance Mining</a>
      ...
      {#if mobileMenuVisible}
        <div class="z-50 origin-top-right absolute right-0 mt-1 thinborder w-56 drowpdown-shadow roundedl">
          <div class="bg-white roundedl" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            ...
            <div class="">
              <a href="#/new_staking" on:click={toggleMobileMenu} class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" role="menuitem">📢 Governance Mining</a>
