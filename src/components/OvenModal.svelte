...
<div class="liquidity-container bg-grey-243 rounded-4px p-4 w-100pc md:p-6 ">
  <button on:click={ () => selectedTab = 1} class="btn m-0 mt-4 rounded-8px p-15px min-w-200px w-96pc lg:w-200px lg:min-w-200px">
      TAB1
  </button>
  <button on:click={ () => selectedTab = 2} class="btn m-0 mt-4 rounded-8px p-15px min-w-200px w-96pc lg:w-200px lg:min-w-200px">
      TAB2
  </button>
