...
<span class="-mt-20px">
  ...
  <div class="bg-lightyellow rounded-xl text-black py-8 px-6">
    ...
    <div class="w-100pc rounded-xl bg-white p-6 mt-4">
      <div class="flex justify-between my-2 h-28px">
        <span class="font-thin text-left">Oven name</span>
        <span class="font-bold text-right flex items-center"><img width="28px" height="28px" class="mr-2" src={images.defiplusl} alt="token name" />DEFI+L</span>
      </div>
      <div class="flex justify-between my-2 h-28px">
        <div class="flex items-center ">
          <span class="font-thin text-left mr-2">Minimum reached</span>
      ...
      <div class="flex justify-between my-2 h-28px">
        <span class="font-thin text-left">Your Pie ready</span>
        <span class="font-bold text-right">123 DEFI+L</span>
      </div>
    </div>
