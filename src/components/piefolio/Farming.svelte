...
<span class="-mt-20px">
  ...
  <div class="bg-lightgreen rounded-xl text-black py-8 px-6">
    <div class="font-huge text-center">Farm Positions</div>

    <div class="flex">

      <div class="flex items-center rounded-xl bg-white p-4 mt-6 mr-2 w-1/2">
      ...
      <div class="flex items-center rounded-xl bg-white p-4 mt-6 ml-2 w-1/2">
        <div class="flex items-center mr-4 text-xl">🧮
          <!-- <img class="" width="40px" height="40px" src={images.doughtoken} alt="token name" /> -->
        </div>
        <div class="flex flex-col justify-around">
