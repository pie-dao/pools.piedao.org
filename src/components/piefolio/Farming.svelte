...
<span class="-mt-20px">
  ...
  <div class="bg-lightgreen rounded-xl text-black py-4 md:py-8 px-2 md:px-6">
    ...
    <div class="flex">
      ...
      <div class="flex items-center rounded-xl bg-white p-4 mt-6 mr-1 md:mr-2 w-1/2">
      ...
      <div class="flex items-center rounded-xl bg-white p-4 mt-6 ml-1 md:ml-2 w-1/2">
        <div class="flex items-center mr-4 text-xl">🧮
          <!-- <img class="" width="40px" height="40px" src={images.doughtoken} alt="token name" /> -->
        </div>
        <div class="flex flex-col justify-around">
    ...
    <a href="link" target="_blank">
      <div class="flex items-center rounded-xl bg-white p-6 mt-2 md:mt-4">
