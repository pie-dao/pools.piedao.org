...
<span class="-mt-20px">
  ...
  <div class="bg-lightblu rounded-xl text-black py-8 px-6 flex flex-col items-center">
    <div class="font-huge text-center">Exchange</div>
    
    
    <div class="flex flex-col nowrap w-100pc swap-from border rounded-xl border-black p-16px bg-white mt-8">
    ...
    <div class="flex flex-col nowrap w-100pc swap-from border rounded-xl border-black p-16px bg-white">
      <div class="flex items-center justify-between">
