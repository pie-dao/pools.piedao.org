...
<div class="flex flex-col md:flex-row flex-grow  md:justify-around text-l mt-20px">
  {#each proposals as proposal}
  <a class="w-full flex flex-grow md:w-1/2 bg-white p-8 mt-4 md:mt-0 mx-4 rounded border-thin" target="_blank" href="{proposal.link}">
